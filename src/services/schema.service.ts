...
function mapType(dataType: FieldDefinition["dataType"]): string {
  switch (dataType) {
    case "integer":
      return "integer";
    case "numeric":
...
function createColumnSql(field: FieldDefinition): string {
  return `  ${field.columnName} ${mapType(field.dataType)}${field.nullable ? "" : " not null"}`;
}

function createSimpleDomainTableSql(layout: TableLayout): string {
...
function createCompaniesSql(): string {
  return [
...
function createEstablishmentsSql(): string {
...
function createEstablishmentSecondaryCnaesSql(): string {
  return [
...
function createPartnersSql(): string {
  return [
...
function createSimplesSql(): string {
  return [
...
function createImportCheckpointsSql(): string {
  return [
...
function createImportQuarantineSql(): string {
  return [
...
function createIndexesSql(): string {
  return [
